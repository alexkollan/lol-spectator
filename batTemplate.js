// batTemplate.js
module.exports = (gameId, platformId, encryptionKey) => `
rem OP.GG Spectate
...
if exist "%RADS_PATH%\\Game" (
	...
	if exist "League of Legends.exe" (
		@start "" "League of Legends.exe" "spectator spectator-consumer.euw1.lol.pvp.net:80 ${encryptionKey} ${gameId} ${platformId}" "-UseRads" "-Locale=!locale!" "-GameBaseDir=.."
		goto :eof
	)
)
...
echo ===================
echo EN: Bat File template base on OP.GG Spectate
echo ===================
@pause
