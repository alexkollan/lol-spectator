...
if exist "%RADS_PATH%\Game" (
	...
	if exist "League of Legends.exe" (
		@start "" "League of Legends.exe" "spectator spectator-consumer.euw1.lol.pvp.net:80 r9bBKD3fIRuZnA29pUz/1Yhon69Fr+B9 6450213095 EUW1" "-UseRads" "-Locale=!locale!" "-GameBaseDir=.."
		goto :eof
	)
)
